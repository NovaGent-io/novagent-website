...
const resultsData = [
  {
    ...
    description: 'From hours to minutes. AI detects and responds to brand threats instantly, protecting your reputation.',
    badge: 'Game Changer'
  },
  {
    icon: Clock,
    percentage: '70',
    title: 'Content Created Faster',
    description: 'Draft press releases, social posts, and thought leadership in seconds, not days.',
    badge: 'Speed Boost'
  },
  {
    icon: Users,
    percentage: '45',
    title: 'More Media Placements',
    description: 'Targeted outreach to the right journalists at the right time increases coverage success.',
    badge: 'PR Win'
  },
  {
    icon: TrendingUp,
    percentage: '200',
    title: 'More ROI Data Points',
    description: 'Comprehensive analytics prove the value of your communications efforts to stakeholders.',
    badge: 'Data Power'
  },
  {
    icon: Shield,
    percentage: '60',
    title: 'Better Brand Sentiment',
    description: 'Proactive reputation management keeps your narrative positive and on-brand.',
    badge: 'Trust Builder'
  },
  {
    icon: Award,
    ...
    description: 'Demonstrable results and consistent service quality keep clients engaged long-term.',
    badge: 'Loyalty Win'
  }
];
