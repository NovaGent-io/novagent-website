...
import { Globe, MessageSquare, TrendingUp, Clock, Sparkles } from 'lucide-react';
...
export function SkillsTimeline() {
  ...
  const timelineEvents = [
    ...
    },
    {
      ...
      skills: ['Content Creation', 'Project Management'],
      icon: TrendingUp,
      color: 'bg-green-500'
    }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <ResultCard value="2 min" label="Crisis response time" />
            <ResultCard value="342" label="Media mentions tracked" />
            <ResultCard value="0" label="Opportunities missed" />
            <ResultCard value="89%" label="Positive sentiment" />
          </div>
        </motion.div>
      </div>
    </section>
