...
import { Brain, Sparkles, Zap, MessageSquare, Users, Star, TrendingUp, FileText, Mic, PenTool, BarChart, Target, GanttChartSquare, AlertCircle, Share2, Globe } from 'lucide-react';
...
export function DashboardPreview() {
  ...
  const skills = [
    ...
    { id: 'brand', name: 'Brand Monitor', icon: Globe, position: { x: 80, y: 20 } },
    ...
    { id: 'crisis', name: 'Crisis Management', icon: AlertCircle, position: { x: 15, y: 50 } },
  ...
  const scenarios = [
    ...
    },
    {
      ...
      story: "Your competitor is mentioned but you're not. AI crafts expert commentary, identifies reporter contact, and sends personalized pitch within 2 minutes."
    },
    {
      trigger: "5 major publications feature your CEO",
      sequence: ['analytics', 'reputation', 'content', 'project'],
      story: "AI tracks coverage reach, analyzes sentiment, generates internal report, and schedules follow-up content to maximize momentum."
    },
    {
      trigger: "Quarterly earnings announcement",
      sequence: ['project', 'content', 'media', 'brand', 'analytics'],
      story: "AI coordinates press release timing, drafts social posts, distributes to media lists, monitors initial reception, and provides real-time analytics."
    }
  ];
