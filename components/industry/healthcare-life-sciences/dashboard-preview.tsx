...
import { Brain, Sparkles, Zap, Heart, Pill, Microscope, UserCheck, ShieldCheck, Activity, FileHeart, Stethoscope } from 'lucide-react';
...
export function DashboardPreview() {
  ...
  const skills = [
    { id: 'intake', name: 'Patient Intake', icon: UserCheck, position: { x: 20, y: 20 } },
    { id: 'appointment', name: 'Appointment Scheduler', icon: Heart, position: { x: 80, y: 20 } },
    { id: 'pharmacy', name: 'Pharmacy Integration', icon: Pill, position: { x: 20, y: 80 } },
    { id: 'lab', name: 'Lab Results Manager', icon: Microscope, position: { x: 80, y: 80 } },
    { id: 'compliance', name: 'HIPAA Compliance', icon: ShieldCheck, position: { x: 15, y: 50 } },
    { id: 'analytics', name: 'Health Analytics', icon: Activity, position: { x: 85, y: 50 } },
    { id: 'records', name: 'EHR Integration', icon: FileHeart, position: { x: 50, y: 15 } },
    { id: 'telehealth', name: 'Telehealth Support', icon: Stethoscope, position: { x: 50, y: 85 } }
  ];

  const scenarios = [
    {
      trigger: "New patient inquiry arrives",
      sequence: ['intake', 'compliance', 'appointment'],
      story: "At 2:30 AM, a patient requests urgent care information. The AI verifies HIPAA compliance, collects intake data, and schedules a morning telehealth appointment."
    },
    {
      trigger: "Lab results ready for review",
      sequence: ['lab', 'analytics', 'records', 'pharmacy'],
      story: "Critical lab results arrive, AI analyzes patterns, updates the EHR, and alerts pharmacy about potential medication adjustments based on findings."
    },
    {
      trigger: "Chronic patient due for check-up",
      sequence: ['analytics', 'appointment', 'telehealth', 'compliance'],
      story: "AI identifies diabetic patient overdue for A1C test, schedules appointment, prepares telehealth backup option, ensuring all HIPAA protocols."
    },
    {
      trigger: "Prescription refill request",
      sequence: ['pharmacy', 'records', 'compliance', 'analytics'],
      story: "AI processes refill request, checks patient history in EHR, verifies prescription compliance, and tracks medication adherence patterns."
    }
  ];
