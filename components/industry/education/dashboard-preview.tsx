...
import { Brain, Sparkles, Zap, MessageSquare, Calendar, Users, Star, TrendingUp, FileText, BookOpen, GraduationCap, School } from 'lucide-react';
...
export function DashboardPreview() {
  ...
  const skills = [
    { id: 'lead', name: 'Student Recruitment', icon: Users, position: { x: 20, y: 20 } },
    { id: 'appointment', name: 'Campus Tours', icon: Calendar, position: { x: 80, y: 20 } },
    { id: 'support', name: 'Student Support', icon: MessageSquare, position: { x: 20, y: 80 } },
    { id: 'reputation', name: 'Online Presence', icon: Star, position: { x: 80, y: 80 } },
    { id: 'enrollment', name: 'Enrollment Mgmt', icon: GraduationCap, position: { x: 15, y: 50 } },
    { id: 'documents', name: 'Admin Workflows', icon: FileText, position: { x: 85, y: 50 } },
    { id: 'learning', name: 'Learning Assistant', icon: BookOpen, position: { x: 50, y: 15 } },
    { id: 'analytics', name: 'Success Analytics', icon: Brain, position: { x: 50, y: 85 } }
  ];

  const scenarios = [
    {
      trigger: "Prospective student inquires at midnight",
      sequence: ['lead', 'support', 'appointment'],
      story: "At 12:15 AM, a high school senior asks about Computer Science programs. The AI instantly engages, answers program questions, and schedules a campus tour for next week."
    },
    {
      trigger: "Parent completes campus visit",
      sequence: ['support', 'reputation', 'enrollment'],
      story: "After a positive campus tour, the AI requests feedback, receives glowing review, and initiates the enrollment process with personalized next steps."
    },
    {
      trigger: "At-risk student identified",
      sequence: ['analytics', 'support', 'learning', 'appointment'],
      story: "AI detects dropping attendance and grades, sends supportive message, offers tutoring resources, and schedules advisor meeting."
    },
    {
      trigger: "International inquiry received",
      sequence: ['lead', 'documents', 'support', 'appointment'],
      story: "AI engages with prospect from India, explains visa process, prepares required documents checklist, and books virtual consultation with international admissions."
    }
  ];
    ...
    <section className="py-16 lg:py-24 bg-slate-50 dark:bg-slate-950">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12 max-w-3xl mx-auto">
          ...
          >
            Watch how multiple AI skills work together to transform education
          </motion.p>
        </div>
