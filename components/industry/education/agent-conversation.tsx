...
import { Bot, User, CheckCircle, TrendingUp, Calendar, Users, Star, FileText, Play, Pause, GraduationCap, BookOpen } from 'lucide-react';
...
export function AgentConversation() {
  ...
  const conversationLoop = [
    {
      type: 'user',
      content: 'Good morning! Can you give me an update on yesterday\'s admissions activity?',
      time: '7:45 AM'
    },
    {
      type: 'agent',
      content: 'Good morning! Yesterday was very productive. Here\'s your summary:',
      details: [
        '- 145 prospective student inquiries',
        '- 28 campus tours scheduled', 
        '- 12 applications completed'
      ],
      summary: 'I engaged with all inquiries within 2 minutes, answered 312 questions about programs, and helped 8 international students with visa requirements.',
      time: '7:45 AM'
    },
    {
      type: 'user',
      content: 'Excellent! Can you tell me which programs are getting the most interest?',
      time: '7:47 AM'
    },
    {
      type: 'agent',
      content: 'I\'ve analyzed inquiries from the past month. Here are the trends:',
      header: 'Most Requested Programs:',
      details: [
        '- Computer Science: 28% of inquiries (up 15%)',
        '- Business Administration: 22% of inquiries',
        '- Nursing: 18% of inquiries (high conversion rate)'
      ],
      recommendation: 'Recommendation: Consider creating more Computer Science content for the website - there\'s clearly growing demand, especially for AI/ML specializations.',
      time: '7:50 AM'
    },
    {
      type: 'user',
      content: 'Great insights! Are there any at-risk students I should know about?',
      time: '7:52 AM'
    },
    {
      type: 'agent',
      content: 'Yes, I\'ve identified 3 students who may need immediate support:',
      tasks: [
        '- Sarah Chen: Missed 3 classes this week, GPA dropping',
        '- Michael Torres: Failed midterm, hasn\'t accessed tutoring',
        '- Emma Williams: Financial aid concerns, considering withdrawal'
      ],
      action: 'I\'ve already sent supportive messages and scheduled advisor meetings for all three',
      time: '7:52 AM'
    },
    {
      type: 'user',
      content: 'Thank you for being proactive. Keep me updated on their progress.',
      time: '7:54 AM'
    },
    {
      type: 'agent',
      content: 'Will do! I\'ll send you an update after their advisor meetings this afternoon.',
      time: '7:54 AM'
    }
  ];
    ...
    <section className="py-16 lg:py-24 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12 max-w-3xl mx-auto">
          ...
          >
            See how education administrators interact with their NovaGent AI
          </motion.p>
        </div>
          ...
          >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-sm text-slate-600 dark:text-slate-400">Active - Supporting students 24/7</span>
                    </div>
                  </div>
                </div>
                <button
            ...
            <div className="bg-slate-100 dark:bg-slate-900 p-4 border-t border-slate-200 dark:border-slate-800">
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-4">
                  <span className="text-slate-600 dark:text-slate-400">24/7 Student support</span>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-500" />
                    <span className="text-slate-700 dark:text-slate-300">
                      {messages.filter(m => m.type === 'agent').length * 89} student interactions today
                    </span>
                  </div>
                </div>
