...
import { Brain, Sparkles, Zap, MessageSquare, Calendar, Users, Shield, TrendingUp, FileText, Phone, DollarSign, BarChart } from 'lucide-react';
...
export function DashboardPreview() {
  ...
  const skills = [
    ...
    { id: 'compliance', name: 'Compliance Management', icon: Shield, position: { x: 20, y: 80 } },
    { id: 'documents', name: 'Legal Documents', icon: FileText, position: { x: 80, y: 80 } },
    { id: 'finance', name: 'Financial Operations', icon: DollarSign, position: { x: 15, y: 50 } },
    { id: 'analytics', name: 'Data Analytics', icon: BarChart, position: { x: 85, y: 50 } },
    { id: 'dialer', name: 'Smart Dialer', icon: Phone, position: { x: 50, y: 15 } },
    { id: 'portfolio', name: 'Portfolio Management', icon: TrendingUp, position: { x: 50, y: 85 } }
  ];

  const scenarios = [
    {
      trigger: "High-net-worth lead identified",
      sequence: ['lead', 'analytics', 'compliance', 'appointment'],
      story: "AI detects a qualified investor, analyzes their profile for suitable products, ensures compliance requirements, and schedules a personalized consultation."
    },
    {
      trigger: "Market volatility alert",
      sequence: ['analytics', 'portfolio', 'dialer', 'compliance'],
      story: "AI monitors market conditions, identifies at-risk portfolios, initiates client outreach calls, and documents all advisory communications for compliance."
    },
    {
      trigger: "New client onboarding request",
      sequence: ['documents', 'compliance', 'finance', 'appointment'],
      story: "AI prepares onboarding documents, runs KYC/AML checks, sets up financial accounts, and schedules initial portfolio review meeting."
    },
    {
      trigger: "Quarterly review approaching",
      sequence: ['portfolio', 'analytics', 'documents', 'appointment'],
      story: "AI analyzes portfolio performance, generates customized reports, prepares review documents, and automatically schedules client meetings."
    }
  ];
