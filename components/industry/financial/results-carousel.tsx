...
const resultsData = [
  {
    ...
    description: 'Automated monitoring of SEC, FINRA, and state regulations ensures zero violations and peace of mind.',
  ...
  },
  {
    ...
    description: 'AI qualifies and nurtures prospects, converting nearly 9 out of 10 qualified leads into clients.',
    badge: 'Growth Engine'
  },
  {
    icon: Clock,
    ...
    description: 'From days to hours. KYC, account setup, and documentation handled seamlessly.',
    badge: 'Time Saved'
  },
  {
    icon: Users,
    percentage: '45',
    title: 'More Client Meetings',
    description: 'Automated scheduling and follow-ups mean advisors spend more time with clients, less on admin.',
    badge: 'Relationship Focus'
  },
  {
    icon: Award,
    percentage: '3.2x',
    title: 'ROI on AI Investment',
    description: 'Reduced operational costs and increased AUM deliver exceptional returns within months.',
  ...
  },
  {
    ...
    description: 'Market monitoring, portfolio optimization, and risk alerts work around the clock for clients.',
    badge: 'Never Sleeps'
  }
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-4">
            Real Results. Real Advisors.
          </h2>
          <p className="text-lg text-slate-600 dark:text-slate-400">
            Every metric tells a story of transformation
          </p>
        </motion.div>
    ...
    >
      ...
      >
        <span className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
          {result.percentage}{result.percentage !== '24/7' && '%'}
        </span>
      </motion.div>
