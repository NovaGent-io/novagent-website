...
const resultsData = [
  {
    ...
    description: 'From 12% to 87%. AI-powered personalization creates messages that resonate with each donor\'s passion.',
  ...
  },
  {
    ...
    description: 'Your team focuses on mission, not paperwork. Every hour saved is an hour serving your community.',
  ...
  },
  {
    ...
    description: 'Smart matching and instant communication keeps volunteers engaged and coming back to serve.',
  ...
  },
  {
    ...
    percentage: '156',
    title: 'ROI Increase',
    description: 'Every dollar invested returns $1.56 more in donations. Your mission gets the resources it deserves.',
    badge: 'Impact Multiplier'
  },
  {
    icon: Shield,
    percentage: '100',
    title: 'Grant Success Rate',
    description: 'AI analyzes RFPs, matches your strengths, and crafts winning proposals that funders can\'t ignore.',
    badge: 'Funding Secured'
  },
  {
    icon: Award,
    percentage: '42',
    title: 'More Major Gifts',
    description: 'Identify, cultivate, and steward major donors with precision timing and personalized outreach.',
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-4">
            Real Impact. Real Organizations.
          </h2>
          <p className="text-lg text-slate-600 dark:text-slate-400">
            Every metric reflects lives changed and missions amplified
          </p>
        </motion.div>
