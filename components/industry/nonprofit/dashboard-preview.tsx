...
import { Brain, Sparkles, Zap, MessageSquare, Calendar, Users, Heart, TrendingUp, FileText, DollarSign } from 'lucide-react';
...
export function DashboardPreview() {
  ...
  const skills = [
    { id: 'donor', name: 'Donor Outreach', icon: Heart, position: { x: 20, y: 20 } },
    { id: 'volunteer', name: 'Volunteer Coordination', icon: Users, position: { x: 80, y: 20 } },
    { id: 'campaign', name: 'Campaign Management', icon: TrendingUp, position: { x: 20, y: 80 } },
    { id: 'impact', name: 'Impact Reporting', icon: FileText, position: { x: 80, y: 80 } },
    { id: 'events', name: 'Event Planning', icon: Calendar, position: { x: 15, y: 50 } },
    { id: 'grants', name: 'Grant Writing', icon: DollarSign, position: { x: 85, y: 50 } },
    { id: 'outreach', name: 'Community Outreach', icon: MessageSquare, position: { x: 50, y: 15 } },
    { id: 'analytics', name: 'Data Analytics', icon: Brain, position: { x: 50, y: 85 } }
  ];

  const scenarios = [
    {
      trigger: "Major donor prospect identified",
      sequence: ['donor', 'analytics', 'impact', 'grants'],
      story: "AI identifies a foundation with matching interests, analyzes giving history, prepares a custom impact report, and drafts a compelling grant proposal."
    },
    {
      trigger: "Volunteer signs up online",
      sequence: ['volunteer', 'events', 'outreach'],
      story: "New volunteer is instantly welcomed, matched to upcoming food drive based on skills, and connected with team leaders in their area."
    },
    {
      trigger: "Year-end campaign launches",
      sequence: ['campaign', 'donor', 'impact', 'analytics'],
      story: "AI segments donors by giving history, personalizes 10,000 appeals, tracks real-time response, and adjusts messaging for maximum impact."
    },
    {
      trigger: "Emergency relief needed",
      sequence: ['outreach', 'volunteer', 'campaign', 'impact'],
      story: "Crisis alert triggers immediate volunteer mobilization, launches emergency fundraising campaign, and provides real-time updates to stakeholders."
    }
  ];
    ...
    <section className="py-16 lg:py-24 bg-slate-50 dark:bg-slate-950">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12 max-w-3xl mx-auto">
          ...
          >
            Watch how multiple AI skills work together to amplify your mission
          </motion.p>
        </div>
