...
import { Brain, Sparkles, Zap, Settings, BarChart3, ShieldCheck, Package, Wrench, Gauge, AlertTriangle, TrendingUp } from 'lucide-react';
...
export function DashboardPreview() {
  ...
  const skills = [
    { id: 'project', name: 'Project Management', icon: Settings, position: { x: 20, y: 20 } },
    { id: 'compliance', name: 'Compliance Management', icon: ShieldCheck, position: { x: 80, y: 20 } },
    { id: 'financial', name: 'Financial Operations', icon: TrendingUp, position: { x: 20, y: 80 } },
    { id: 'analytics', name: 'Data Analytics', icon: BarChart3, position: { x: 80, y: 80 } },
    { id: 'inventory', name: 'Inventory Control', icon: Package, position: { x: 15, y: 50 } },
    { id: 'quality', name: 'Quality Assurance', icon: Gauge, position: { x: 85, y: 50 } },
    { id: 'maintenance', name: 'Predictive Maintenance', icon: Wrench, position: { x: 50, y: 15 } },
    { id: 'safety', name: 'Safety Monitoring', icon: AlertTriangle, position: { x: 50, y: 85 } }
  ];

  const scenarios = [
    {
      trigger: "Quality alert detected",
      sequence: ['quality', 'compliance', 'project', 'analytics'],
      story: "AI detects a 2% quality variance in Line 3. It immediately flags the issue, checks compliance requirements, adjusts production schedules, and analyzes root cause patterns."
    },
    {
      trigger: "Supply chain disruption",
      sequence: ['inventory', 'project', 'financial', 'analytics'],
      story: "Critical component shortage detected. AI reallocates inventory, reschedules production, calculates financial impact, and suggests alternative suppliers."
    },
    {
      trigger: "Machine anomaly pattern",
      sequence: ['maintenance', 'safety', 'project', 'financial'],
      story: "AI predicts bearing failure in 72 hours. It schedules preventive maintenance, ensures safety protocols, minimizes production impact, and orders replacement parts."
    },
    {
      trigger: "Rush order received",
      sequence: ['project', 'inventory', 'quality', 'analytics'],
      story: "Large priority order arrives. AI optimizes production schedule, confirms material availability, sets quality checkpoints, and projects delivery timeline."
    }
  ];
