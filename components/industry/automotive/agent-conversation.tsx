...
import { Bot, User, CheckCircle, TrendingUp, Calendar, Users, Star, FileText, Play, Pause } from 'lucide-react';
...
export function AgentConversation() {
  ...
  const conversationLoop = [
    {
      type: 'user',
      content: 'Good morning! Can you give me a summary of yesterday\'s performance?',
      time: '8:15 AM'
    },
    {
      type: 'agent',
      content: 'Good morning! Yesterday was excellent. Here\'s your summary:',
      details: [
        '- 62 leads captured',
        '- 14 appointments booked', 
        '- 3 new 5-star reviews'
      ],
      summary: 'I responded to all internet inquiries within 5 minutes and scheduled test drives for 8 qualified buyers.',
      time: '8:15 AM'
    },
    {
      type: 'user',
      content: 'Perfect. Also, can you identify which online sources are bringing us the best quality leads?',
      time: '8:17 AM'
    },
    {
      type: 'agent',
      content: 'I\'ve analyzed last month\'s data. Here\'s what I found:',
      header: 'Top Performing Lead Sources:',
      details: [
        '- Cars.com: 42% conversion rate (highest quality)',
        '- Your website: 38% conversion rate',
        '- AutoTrader: 31% conversion rate'
      ],
      recommendation: 'Recommendation: Consider increasing your Cars.com budget - those leads are converting at nearly double the rate of CarGurus.',
      time: '8:20 AM'
    },
    {
      type: 'user',
      content: 'Great insights! Any high-priority tasks for today?',
      time: '8:22 AM'
    },
    {
      type: 'agent',
      content: 'Yes, I\'ve identified 3 high-priority opportunities:',
      tasks: [
        '- Follow up with 5 hot leads from last night',
        '- Schedule test drives for 3 cash buyers',
        '- Remind 12 customers about overdue service'
      ],
      action: 'I\'ll start working on these immediately',
      time: '8:22 AM'
    },
    {
      type: 'user',
      content: 'Sounds good. Let me know if you need anything from the team.',
      time: '8:24 AM'
    },
    {
      type: 'agent',
      content: 'Will do! I\'ll send you an update at noon with progress on all fronts.',
      time: '8:24 AM'
    }
  ];
    ...
    <section className="py-16 lg:py-24 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12 max-w-3xl mx-auto">
          ...
          >
            See how dealership managers interact with their NovaGent AI
          </motion.p>
        </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-slate-700 dark:text-slate-300">
                      {messages.filter(m => m.type === 'agent').length * 47} tasks completed today
                    </span>
                  </div>
                </div>
