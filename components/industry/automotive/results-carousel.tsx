...
const resultsData = [
  {
    ...
    description: 'From hours to minutes. Every lead engaged instantly, dramatically boosting conversion rates.',
    badge: 'Game Changer'
  },
  {
    icon: Clock,
    percentage: '25',
    title: 'Fewer Scheduling Delays',
    description: 'Smart automation eliminates double-bookings and keeps your service bays profitable.',
  ...
  },
  {
    ...
    description: 'Consistent, personalized experiences that turn first-time buyers into lifetime advocates.',
  ...
  },
  {
    ...
    description: 'Proactive service reminders and intelligent upselling transform your bottom line.',
    badge: 'Profit Surge'
  },
  {
    icon: Shield,
    ...
    description: 'Automated requests at the perfect moment build an unbeatable online reputation.',
    badge: 'Reputation Win'
  },
  {
    icon: Award,
    percentage: '30',
    title: 'Sales Productivity',
    description: 'Your best people focus on relationships while AI handles the repetitive tasks.',
    badge: 'Team Power'
  }
];
