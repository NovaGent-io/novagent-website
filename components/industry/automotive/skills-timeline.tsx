...
const timelineData = [
  {
    ...
    description: 'Customer browses your inventory on Cars.com and submits inquiry for a 2024 Honda CR-V',
  ...
  },
  {
    ...
    description: 'Agent responds within 60 seconds with personalized message, vehicle details, and financing options',
  ...
  },
  {
    ...
    description: 'Agent sends friendly text asking if customer would like to schedule a test drive today',
    skill: 'Lead Generation',
    color: 'from-purple-500 to-pink-500'
  },
  {
    ...
    description: 'Customer responds, agent books 2 PM test drive and sends calendar invite with directions',
  ...
  },
  {
    ...
    description: 'After successful test drive and purchase, agent handles insurance questions',
    skill: 'Customer Support',
    color: 'from-blue-500 to-cyan-500'
  },
  {
    ...
    description: 'Agent sends personalized message asking happy customer to share their experience online',
    skill: 'SEO & Reputation',
    ...
    <section className="py-16 lg:py-24 bg-slate-50 dark:bg-slate-950 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 max-w-3xl mx-auto">
          ...
          >
            Your AI Agent's 24-Hour Customer Journey
          </motion.h2>
          <motion.p 
          ...
          >
            See how one agent with multiple skills creates seamless experiences
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <ResultCard value="17 hrs" label="From lead to sale" />
            <ResultCard value="6" label="Touchpoints managed" />
            <ResultCard value="0" label="Staff hours required" />
            <ResultCard value="5 ⭐" label="Review received" />
          </div>
        </motion.div>
      </div>
    </section>
