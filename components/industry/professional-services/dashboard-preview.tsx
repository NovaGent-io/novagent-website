...
import { Brain, Sparkles, Zap, Target, Calendar, GanttChartSquare, Calculator, TrendingUp, FileCheck, ClipboardCheck, LineChart } from 'lucide-react';
...
export function DashboardPreview() {
  ...
  const skills = [
    { id: 'lead', name: 'Lead Generation', icon: Target, position: { x: 20, y: 20 } },
    { id: 'appointment', name: 'Appointment Setting', icon: Calendar, position: { x: 80, y: 20 } },
    { id: 'project', name: 'Project Management', icon: GanttChartSquare, position: { x: 20, y: 80 } },
    { id: 'finance', name: 'Financial Operations', icon: Calculator, position: { x: 80, y: 80 } },
    { id: 'analytics', name: 'Data Analytics', icon: LineChart, position: { x: 15, y: 50 } },
    { id: 'contracts', name: 'Contract Management', icon: FileCheck, position: { x: 85, y: 50 } },
    { id: 'compliance', name: 'Compliance Tracking', icon: ClipboardCheck, position: { x: 50, y: 15 } },
    { id: 'billing', name: 'Automated Billing', icon: TrendingUp, position: { x: 50, y: 85 } }
  ];

  const scenarios = [
    {
      trigger: "New RFP opportunity identified",
      sequence: ['lead', 'analytics', 'project', 'contracts'],
      story: "AI identifies a perfect-fit RFP, analyzes win probability, creates project timeline, and drafts initial proposal - all before your team wakes up."
    },
    {
      trigger: "Qualified lead requests consultation",
      sequence: ['lead', 'appointment', 'analytics', 'project'],
      story: "Prospect books directly into partner's calendar, AI prepares client insights, suggests project scope, and creates preliminary timeline."
    },
    {
      trigger: "Project milestone completed",
      sequence: ['project', 'compliance', 'finance', 'billing'],
      story: "AI detects completion, verifies deliverables meet contract terms, calculates billable hours, and automatically generates invoice."
    },
    {
      trigger: "Month-end billing cycle",
      sequence: ['billing', 'analytics', 'finance', 'contracts'],
      story: "AI compiles all billable activities, analyzes project profitability, processes invoices, and flags any contract renewal opportunities."
    }
  ];
    ...
    <section className="py-16 lg:py-24 bg-slate-50 dark:bg-slate-950">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12 max-w-3xl mx-auto">
          ...
          >
            Watch how multiple AI skills work together to maximize billable hours
          </motion.p>
        </div>
