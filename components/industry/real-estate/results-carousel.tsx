...
const resultsData = [
  {
    ...
    description: 'Every inquiry answered instantly, 24/7. Never lose another buyer to a competitor who responds first.',
    badge: 'Speed Wins'
  },
  {
    icon: Clock,
    ...
    description: 'AI coordinates schedules perfectly, eliminating back-and-forth and filling your calendar with qualified buyers.',
    badge: 'Time Saver'
  },
  {
    icon: Users,
    ...
    description: 'Smart lead qualification and instant follow-up turns more inquiries into closed deals.',
    badge: 'Sales Power'
  },
  {
    icon: TrendingUp,
    ...
    description: 'Handle more transactions without adding staff. Your AI scales with your success.',
    badge: 'Profit Boost'
  },
  {
    icon: Shield,
    ...
    description: 'Consistent communication and instant responses create 5-star experiences every time.',
    badge: 'Trust Builder'
  },
  {
    icon: Award,
    percentage: '65',
    title: 'Repeat & Referral Business',
    description: 'Happy clients become your best marketers when every interaction exceeds expectations.',
    badge: 'Growth Engine'
  }
];
