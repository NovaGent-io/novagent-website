...
import { Brain, Sparkles, Zap, Home, Calendar, Users, Star, FileText, Phone, Database, MapPin } from 'lucide-react';
...
export function DashboardPreview() {
  ...
  const skills = [
    ...
    { id: 'property', name: 'Property Management', icon: Home, position: { x: 20, y: 80 } },
    { id: 'reputation', name: 'SEO & Reputation', icon: Star, position: { x: 80, y: 80 } },
    { id: 'documents', name: 'Legal Documents', icon: FileText, position: { x: 15, y: 50 } },
    { id: 'database', name: 'MLS Integration', icon: Database, position: { x: 85, y: 50 } },
    { id: 'dialer', name: 'Smart Dialer', icon: Phone, position: { x: 50, y: 15 } },
    { id: 'tours', name: 'Virtual Tours', icon: MapPin, position: { x: 50, y: 85 } }
  ];

  const scenarios = [
    {
      trigger: "Zillow lead at 10:47 PM",
      sequence: ['lead', 'property', 'appointment', 'tours'],
      story: "Buyer inquires about 4-bed colonial. AI instantly provides details, schedules showing for tomorrow, and sends virtual tour link."
    },
    {
      trigger: "Just listed notification triggers",
      sequence: ['database', 'lead', 'dialer', 'appointment'],
      story: "New listing matches 15 buyer criteria. AI alerts matched buyers, calls top 5 prospects, books 3 showings for opening weekend."
    },
    {
      trigger: "Offer accepted on Sunday evening",
      sequence: ['documents', 'appointment', 'reputation'],
      story: "AI drafts purchase agreement, schedules inspection, notifies all parties, and requests review from happy buyers."
    },
    {
      trigger: "Multiple offers situation",
      sequence: ['lead', 'documents', 'database', 'dialer'],
      story: "AI manages 6 competing offers, tracks deadlines, prepares comparison sheet, and coordinates final negotiations."
    }
  ];
    ...
    <section className="py-16 lg:py-24 bg-slate-50 dark:bg-slate-950">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12 max-w-3xl mx-auto">
          ...
          >
            See Your Real Estate AI in Action
          </motion.h2>
          <motion.p 
          ...
          >
            Watch how multiple AI skills work together to close more deals
          </motion.p>
        </div>
