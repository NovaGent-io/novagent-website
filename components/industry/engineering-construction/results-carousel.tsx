...
import { Zap, Clock, Shield, TrendingUp, HardHat, Award } from 'lucide-react';
...
const resultsData = [
  {
    ...
    description: 'AI-driven scheduling and resource optimization delivers projects weeks ahead of traditional timelines.',
    badge: 'Time Saver'
  },
  {
    icon: Clock,
    percentage: '68',
    title: 'Reduction in Change Orders',
    description: 'Proactive issue detection and precise documentation prevent costly mid-project modifications.',
    badge: 'Cost Control'
  },
  {
    icon: Shield,
    ...
    description: 'Real-time monitoring ensures every worker, every task, every day meets OSHA standards.',
  ...
  },
  {
    ...
    description: 'Optimized bidding, reduced waste, and efficient resource allocation boost bottom-line results.',
    badge: 'Profit Leader'
  },
  {
    icon: HardHat,
    percentage: '89',
    title: 'Bid Win Rate',
    description: 'Data-driven proposals with accurate costing and proven track records win more contracts.',
    badge: 'Market Winner'
  },
  {
    icon: Award,
    ...
    description: 'On-time delivery, transparent communication, and quality results create lasting partnerships.',
    badge: 'Trust Builder'
  }
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400">
            Every metric tells a story of construction excellence
          </p>
        </motion.div>
