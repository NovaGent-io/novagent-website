...
import { Brain, Sparkles, Zap, Shield, AlertTriangle, Activity, BarChart3, Users, FileCheck, Wrench } from 'lucide-react';
...
export function DashboardPreview() {
  ...
  const skills = [
    { id: 'compliance', name: 'Compliance Management', icon: Shield, position: { x: 20, y: 20 } },
    { id: 'project', name: 'Project Management', icon: Activity, position: { x: 80, y: 20 } },
    { id: 'support', name: 'Customer Support', icon: Users, position: { x: 20, y: 80 } },
    { id: 'analytics', name: 'Data Analytics', icon: BarChart3, position: { x: 80, y: 80 } },
    { id: 'alert', name: 'Alert Monitoring', icon: AlertTriangle, position: { x: 15, y: 50 } },
    { id: 'documents', name: 'Document Control', icon: FileCheck, position: { x: 85, y: 50 } },
    { id: 'infrastructure', name: 'Infrastructure Ops', icon: Wrench, position: { x: 50, y: 15 } },
    { id: 'power', name: 'Grid Intelligence', icon: Zap, position: { x: 50, y: 85 } }
  ];

  const scenarios = [
    {
      trigger: "Critical infrastructure alert detected",
      sequence: ['alert', 'infrastructure', 'project', 'compliance'],
      story: "At 3:14 AM, grid sensors detect anomaly in Sector 7. AI immediately analyzes threat level, dispatches maintenance crew, updates project timeline, and files regulatory notice."
    },
    {
      trigger: "New regulatory compliance update",
      sequence: ['compliance', 'documents', 'analytics', 'project'],
      story: "EPA releases new emissions standard. AI scans requirements, updates 47 operational documents, analyzes impact on current metrics, and adjusts project priorities."
    },
    {
      trigger: "Major storm approaching service area",
      sequence: ['alert', 'support', 'infrastructure', 'analytics'],
      story: "Weather system triggers emergency protocols. AI proactively notifies 12,000 customers, pre-positions repair crews, and begins real-time outage prediction modeling."
    },
    {
      trigger: "Quarterly compliance audit initiated",
      sequence: ['compliance', 'documents', 'analytics', 'power'],
      story: "Automated audit begins. AI compiles 90 days of operational data, generates compliance reports, identifies 3 optimization opportunities, and schedules grid adjustments."
    }
  ];
