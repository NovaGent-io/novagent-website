...
import { Zap, Clock, Shield, TrendingUp, AlertTriangle, Users } from 'lucide-react';
...
const resultsData = [
  {
    ...
    description: 'Predictive AI prevents outages before they happen, keeping the lights on for millions.',
  ...
  },
  {
    ...
    description: 'Critical infrastructure issues resolved in minutes, not hours. Automated dispatch saves lives.',
  ...
  },
  {
    ...
    description: 'Every regulation tracked, every report filed on time. Zero violations, zero fines.',
    badge: 'Audit Perfect'
  },
  {
    icon: TrendingUp,
    ...
    description: 'Optimized maintenance schedules and resource allocation slash operational expenses.',
    badge: 'ROI Champion'
  },
  {
    icon: AlertTriangle,
    ...
    description: 'AI identifies risks before they become problems, protecting infrastructure and communities.',
    badge: 'Safety First'
  },
  {
    icon: Users,
    ...
    description: 'Proactive communications and faster resolutions create trust with every interaction.',
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-4">
            Real Results. Real Utilities.
          </h2>
          <p className="text-lg text-slate-600 dark:text-slate-400">
            Every metric tells a story of reliability and efficiency
          </p>
        </motion.div>
