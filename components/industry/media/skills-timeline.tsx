...
const timelineData = [
  {
    ...
    description: 'AI identifies emerging trend in tech space with 340% engagement spike across platforms',
    skill: 'Audience Analytics',
    color: 'from-purple-500 to-pink-500'
  },
  {
    time: '2:15 AM',
    title: 'Content Creation Sprint',
    description: 'Agent generates 5 content variations optimized for different platforms and audiences',
    skill: 'Content Creation',
    color: 'from-blue-500 to-cyan-500'
  },
  {
    time: '6:00 AM',
    title: 'Optimal Distribution',
    description: 'Content scheduled across 12 channels at peak engagement times for each audience segment',
    skill: 'Media Distribution',
    color: 'from-green-500 to-emerald-500'
  },
  {
    time: '10:00 AM',
    title: 'Real-Time Engagement',
    description: 'Agent responds to top comments, amplifies positive feedback, manages brand voice',
  ...
  },
  {
    ...
    description: 'Comprehensive report shows 2.3M views, 89% positive sentiment, $45K revenue generated',
  ...
  },
  {
    ...
    description: 'AI negotiates syndication deals, optimizes ad placement, manages licensing renewals',
    skill: 'Rights Management',
    ...
    <section className="py-16 lg:py-24 bg-slate-50 dark:bg-slate-950 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 max-w-3xl mx-auto">
          ...
          >
            Your AI Agent's 24-Hour Content Lifecycle
          </motion.h2>
          <motion.p 
          ...
          >
            See how one agent with multiple skills creates viral content experiences
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <ResultCard value="22 hrs" label="From trend to profit" />
            <ResultCard value="2.3M" label="Total reach achieved" />
            <ResultCard value="$45K" label="Revenue generated" />
            <ResultCard value="340%" label="Engagement increase" />
          </div>
        </motion.div>
      </div>
    </section>
