...
import { Brain, Sparkles, Zap, MessageSquare, Calendar, Users, Star, TrendingUp, FileText, Phone, Film, Radio, Mic, Play, Pause, BarChart, Share2, Camera } from 'lucide-react';
...
export function DashboardPreview() {
  ...
  const skills = [
    { id: 'content', name: 'Content Creation', icon: Film, position: { x: 20, y: 20 } },
    { id: 'distribution', name: 'Media Distribution', icon: Share2, position: { x: 80, y: 20 } },
    { id: 'analytics', name: 'Audience Analytics', icon: BarChart, position: { x: 20, y: 80 } },
    { id: 'rights', name: 'Rights Management', icon: FileText, position: { x: 80, y: 80 } },
    { id: 'engagement', name: 'Audience Engagement', icon: MessageSquare, position: { x: 15, y: 50 } },
    { id: 'scheduling', name: 'Content Scheduling', icon: Calendar, position: { x: 85, y: 50 } },
    { id: 'production', name: 'Production Tracking', icon: Camera, position: { x: 50, y: 15 } },
    { id: 'monetization', name: 'Revenue Optimization', icon: TrendingUp, position: { x: 50, y: 85 } }
  ];

  const scenarios = [
    {
      trigger: "Viral content opportunity detected",
      sequence: ['analytics', 'content', 'distribution', 'engagement'],
      story: "AI identifies trending topic at 2 AM, creates relevant content, schedules optimal distribution, and engages with early audience reactions."
    },
    {
      trigger: "Content performance alert",
      sequence: ['analytics', 'engagement', 'monetization', 'content'],
      story: "A video exceeds view targets by 300%. AI analyzes why, engages hot audience segments, optimizes ad placement, and creates follow-up content."
    },
    {
      trigger: "Rights expiration warning",
      sequence: ['rights', 'analytics', 'scheduling', 'distribution'],
      story: "Licensed content expires in 7 days. AI checks performance data, reschedules final push, maximizes distribution before deadline."
    },
    {
      trigger: "Production deadline approaching",
      sequence: ['production', 'content', 'rights', 'scheduling'],
      story: "Post-production behind schedule. AI reallocates resources, generates placeholder content, clears rights issues, and adjusts release calendar."
    }
  ];
