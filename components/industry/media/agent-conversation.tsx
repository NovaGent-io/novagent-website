...
import { Bot, User, CheckCircle, TrendingUp, Calendar, Users, Star, FileText, Play, Pause, Film, BarChart, Radio, Share2 } from 'lucide-react';
...
export function AgentConversation() {
  ...
  const conversationLoop = [
    {
      type: 'user',
      content: 'Good morning! What\'s trending in our content space right now?',
      time: '6:30 AM'
    },
    {
      type: 'agent',
      content: 'Good morning! I\'ve been monitoring trends overnight. Here\'s what\'s hot:',
      details: [
        '- #TechInnovation videos up 340% in engagement',
        '- Behind-the-scenes content performing 2.5x better than average', 
        '- Short-form clips under 60 seconds seeing 85% completion rates'
      ],
      summary: 'I\'ve already drafted 3 content ideas aligned with these trends for your review.',
      time: '6:30 AM'
    },
    {
      type: 'user',
      content: 'Excellent! Also, how did yesterday\'s premium content release perform?',
      time: '6:32 AM'
    },
    {
      type: 'agent',
      content: 'Yesterday\'s premium release exceeded all targets:',
      header: 'Performance Metrics:',
      details: [
        '- 2.3M views in first 24 hours (150% of target)',
        '- 89% positive sentiment from 12K comments analyzed',
        '- Already generated $45K in direct revenue'
      ],
      recommendation: 'Recommendation: The audience is highly engaged. I suggest releasing the bonus content today at 2 PM EST for maximum impact.',
      time: '6:33 AM'
    },
    {
      type: 'user',
      content: 'That\'s fantastic! Any licensing issues we need to address?',
      time: '6:35 AM'
    },
    {
      type: 'agent',
      content: 'I\'ve completed a full rights audit. Three items need attention:',
      tasks: [
        '- Music license for Episode 4 expires in 10 days',
        '- Syndication rights for Series B ready for renewal',
        '- New distribution opportunity: Netflix interested in our documentary catalog'
      ],
      action: 'I\'ve prepared all renewal documents and negotiation briefs for your review',
      time: '6:35 AM'
    },
    {
      type: 'user',
      content: 'Perfect. Schedule the Netflix meeting and prep the renewal contracts.',
      time: '6:37 AM'
    },
    {
      type: 'agent',
      content: 'Done! Netflix meeting scheduled for Thursday at 3 PM. All contracts will be ready by noon today. I\'ll also prepare a real-time dashboard for the bonus content launch.',
      time: '6:37 AM'
    }
  ];
    ...
    <section className="py-16 lg:py-24 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12 max-w-3xl mx-auto">
          ...
          >
            See how media executives interact with their NovaGent AI
          </motion.p>
        </div>
          ...
          >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-sm text-slate-600 dark:text-slate-400">Active - Monitoring all content channels</span>
                    </div>
                  </div>
                </div>
                <button
            ...
            <div className="bg-slate-100 dark:bg-slate-900 p-4 border-t border-slate-200 dark:border-slate-800">
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-4">
                  <span className="text-slate-600 dark:text-slate-400">24/7 content intelligence</span>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-500" />
                    <span className="text-slate-700 dark:text-slate-300">
                      {messages.filter(m => m.type === 'agent').length * 156} content pieces analyzed today
                    </span>
                  </div>
                </div>
