...
const resultsData = [
  {
    ...
    description: 'From days to hours. AI generates, edits, and optimizes content across all formats instantly.',
    badge: 'Speed Champion'
  },
  {
    icon: Clock,
    percentage: '92',
    title: 'Content Utilization Rate',
    description: 'Smart distribution ensures every piece of content reaches its maximum audience potential.',
  ...
  },
  {
    ...
    description: 'AI-driven personalization creates deeper connections with every viewer interaction.',
    badge: 'Engagement King'
  },
  {
    icon: TrendingUp,
    percentage: '67',
    title: 'Revenue Growth',
    description: 'Optimized monetization strategies and perfect timing maximize every content dollar.',
    badge: 'Profit Engine'
  },
  {
    icon: Shield,
    ...
    description: 'Automated tracking prevents costly violations and ensures every asset is properly licensed.',
    badge: 'Legal Shield'
  },
  {
    icon: Award,
    ...
    description: 'Data-driven content strategies produce award-winning results that elevate your brand.',
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400">
            Every metric tells a story of creative transformation
          </p>
        </motion.div>
