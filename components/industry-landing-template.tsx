            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button
                  asChild
                  size="lg"
                  className="w-full sm:w-auto bg-blue-600 sm:bg-gradient-to-r sm:from-blue-600 sm:to-purple-600 hover:bg-blue-700 sm:hover:from-blue-700 sm:hover:to-purple-700 text-white font-semibold text-sm sm:text-base md:text-lg px-4 py-3 sm:px-6 sm:py-4 md:px-10 md:py-6 rounded-md sm:rounded-lg shadow-sm sm:shadow-md md:shadow-lg shadow-blue-600/20 sm:shadow-blue-700/10 md:shadow-blue-700/20 hover:shadow-blue-600/30 sm:hover:shadow-blue-700/20 md:hover:shadow-blue-700/40 transition-all duration-150 sm:duration-200 md:duration-300 transform active:scale-95 sm:hover:scale-[1.01] md:hover:scale-105 border-0 touch-manipulation select-none"
                >
