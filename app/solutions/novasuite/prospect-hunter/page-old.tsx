...
import { ArrowLeft, Search, Target, Filter, Globe, Database, Zap, CheckCircle } from 'lucide-react'
...
export default function ProspectHunterPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-gray-900 dark:text-gray-100">
      ...
      <div className="bg-slate-50 dark:bg-slate-900/50 border-b border-gray-200 dark:border-slate-800">
      ...
      <section className="relative pt-20 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 dark:bg-slate-900/50 border border-blue-200 dark:border-purple-500/30 rounded-full mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
            <div className="bg-slate-50 dark:bg-slate-900/30 backdrop-blur-sm border border-gray-200 dark:border-blue-500/20 rounded-xl p-6">
              <div className="text-4xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
                5x
              </div>
              <div className="text-gray-600 dark:text-gray-400 mt-2">More Qualified Leads</div>
            </div>
            <div className="bg-slate-50 dark:bg-slate-900/30 backdrop-blur-sm border border-gray-200 dark:border-blue-500/20 rounded-xl p-6">
              <div className="text-4xl font-bold bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
                80%
              </div>
              <div className="text-gray-600 dark:text-gray-400 mt-2">Time Saved on Research</div>
            </div>
            <div className="bg-slate-50 dark:bg-slate-900/30 backdrop-blur-sm border border-gray-200 dark:border-blue-500/20 rounded-xl p-6">
              <div className="text-4xl font-bold bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent">
                24/7
              </div>
              <div className="text-gray-600 dark:text-gray-400 mt-2">Always Hunting</div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/pricing"
              className="px-8 py-4 text-gray-700 dark:text-gray-100 bg-transparent border border-gray-300 dark:border-gray-600 rounded-lg font-medium hover:border-purple-600 transition-colors"
            >
              View Pricing
            </Link>
          </div>
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Set specific criteria like industry, company size, technology stack, and job titles to target exactly who you want.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Your agent searches across multiple data sources, social networks, and databases to find matching prospects.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Each prospect is scored based on buying signals, engagement data, and fit with your ideal customer profile.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Get complete prospect profiles with contact info, company insights, and personalized talking points delivered to your CRM.</p>
                </div>
              </div>
            </div>

            {/* Demo Card */}
            <div className="bg-white dark:bg-slate-900/50 backdrop-blur-sm border border-gray-200 dark:border-purple-500/20 rounded-2xl p-8 shadow-lg dark:shadow-none">
              <div className="text-center mb-6">
                <div className="text-cyan-600 dark:text-cyan-400 text-sm mb-2">Live Prospect Hunter Demo</div>
                <div className="text-2xl font-mono text-gray-700 dark:text-gray-300">Scanning LinkedIn Sales Navigator...</div>
              </div>
              
              <div className="space-y-3">
                <div className="bg-gray-50 dark:bg-slate-900/50 rounded-lg p-3 flex justify-between items-center">
                  <span className="text-gray-700 dark:text-gray-300">Tech startup, 50-200 employees, Series B</span>
                  <CheckCircle className="w-5 h-5 text-green-500" />
                </div>
                <div className="bg-gray-50 dark:bg-slate-900/50 rounded-lg p-3 flex justify-between items-center opacity-75">
                  <span className="text-gray-700 dark:text-gray-300">VP of Sales - Decision maker identified</span>
                  <span className="text-yellow-500">?</span>
                </div>
                <div className="bg-gray-50 dark:bg-slate-900/50 rounded-lg p-3 opacity-50">
                  <span className="text-gray-500">Analyzing buying signals...</span>
                </div>
              </div>

              <div className="mt-6 text-center">
                <div className="text-sm text-gray-600 dark:text-gray-400">12 qualified prospects found</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-gray-50 dark:bg-slate-900/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-slate-900/50 backdrop-blur-sm border border-gray-200 dark:border-purple-500/20 rounded-xl p-6 hover:border-cyan-500 dark:hover:border-cyan-500/50 transition-colors">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">Searches across LinkedIn, company websites, industry databases, and social media to find prospects everywhere.</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900/50 backdrop-blur-sm border border-gray-200 dark:border-purple-500/20 rounded-xl p-6 hover:border-cyan-500 dark:hover:border-cyan-500/50 transition-colors">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">Uses 50+ data points to identify prospects that match your exact ideal customer profile.</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900/50 backdrop-blur-sm border border-gray-200 dark:border-purple-500/20 rounded-xl p-6 hover:border-cyan-500 dark:hover:border-cyan-500/50 transition-colors">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">Automatically scores and ranks prospects based on buying intent signals and fit criteria.</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900/50 backdrop-blur-sm border border-gray-200 dark:border-purple-500/20 rounded-xl p-6 hover:border-cyan-500 dark:hover:border-cyan-500/50 transition-colors">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">Enhances every lead with verified contact details, company info, and personalized insights.</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900/50 backdrop-blur-sm border border-gray-200 dark:border-purple-500/20 rounded-xl p-6 hover:border-cyan-500 dark:hover:border-cyan-500/50 transition-colors">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">Get notified instantly when high-value prospects show buying signals or match trigger events.</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900/50 backdrop-blur-sm border border-gray-200 dark:border-purple-500/20 rounded-xl p-6 hover:border-cyan-500 dark:hover:border-cyan-500/50 transition-colors">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">Seamlessly syncs with Salesforce, HubSpot, and other CRMs to keep your pipeline always full.</p>
            </div>
          </div>
        </div>
      </section>
