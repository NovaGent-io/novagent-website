    ...
    <div className="flex flex-col">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              Each skill is a powerful tool on its own, but together they create an unstoppable enterprise operations engine
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              Watch how your AI agent orchestrates seamless enterprise operations from project inception to financial reporting
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-slate-50 dark:bg-slate-900/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              Why Choose the <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">Enterprise-Ops Bundle</span>
            </h2>
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              More than just tools - a complete enterprise transformation
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              Based on our proven implementation methodology, here's what you can expect when you activate the Enterprise-Ops Bundle
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-300">
                Everything you need to know about the Enterprise-Ops Bundle
              </p>
            </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold mb-2 text-slate-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                      How do AI Credits work with the Enterprise-Ops Bundle?
                    </h3>
                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                      The Enterprise-Ops Bundle works seamlessly with our flexible pricing tiers. When you're on the <span className="font-semibold text-purple-600 dark:text-purple-400">Scale Plan</span>, you receive a <span className="font-semibold">custom AI Credit pool</span> tailored to your enterprise needs. These credits power all four skills in your bundle - from project management to financial operations. Your AI agent intelligently optimizes credit usage across all activities to maximize your ROI.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-3 text-slate-600 dark:text-slate-400">
                      <p className="leading-relaxed">
                        We've designed our plans to be generous with AI Credits to handle typical usage. If you find yourself consistently needing more credits, it's the perfect time to upgrade:
                      </p>
            ...
            <div className="mt-12 text-center bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-8 border border-purple-200 dark:border-purple-700">
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-6">
                Our team is here to help you understand how the Enterprise-Ops Bundle can transform your organization
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 text-purple-100">
              Join leading enterprises using the Enterprise-Ops Bundle to transform their operations
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-white text-purple-600 hover:bg-purple-50" asChild>
                <Link href="/contact">
                  Start with Enterprise-Ops Bundle
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10" asChild>
