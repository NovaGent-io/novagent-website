...
export default function GrowthGTMKitPage() {
  const benefits = [
    {
    ...
    <div className="flex flex-col">
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-purple-600 hover:bg-purple-700" asChild>
                <Link href="/contact">Get Started with Growth Kit</Link>
              </Button>
      ...
      <section className="py-16 sm:py-24 bg-slate-50 dark:bg-slate-900/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              Why Choose the <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">Growth Kit</span>
            </h2>
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
      ...
      <section className="py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              Based on our proven implementation methodology, here's what you can expect when you activate the Growth & GTM Kit
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-300">
                Everything you need to know about the Growth & GTM Kit
              </p>
            </div>
            ...
            <div className="grid gap-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold mb-2 text-slate-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                      How do AI Credits work with the Growth Kit?
                    </h3>
                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                      The Growth Kit works seamlessly with our flexible pricing tiers. When you're on the <span className="font-semibold text-purple-600 dark:text-purple-400">Growth Plan ($1,749/month)</span>, you receive <span className="font-semibold">20,000 AI Credits</span> monthly. These credits power all four skills in your kit - from lead generation to reputation management. Your AI agent intelligently optimizes credit usage across all activities to maximize your ROI.
                    </p>
                  </div>
                </div>
              ...
              <div className="group relative bg-white dark:bg-slate-800 rounded-2xl p-6 transition-all duration-300 hover:shadow-xl border border-slate-200 dark:border-slate-700 hover:border-purple-300 dark:hover:border-purple-600">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold mb-2 text-slate-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                      Can I add more skills to my kit later?
                    </h3>
                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                      Absolutely! The Growth Plan supports <span className="font-semibold">up to 8 active skills</span>, so you have room to expand beyond the 4 skills in this kit. You can add individual skills anytime through your dashboard. For maximum flexibility, consider our <span className="font-semibold text-purple-600 dark:text-purple-400">Scale Plan</span> which offers unlimited skills.
                    </p>
                  </div>
                </div>
                <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-purple-600/10 to-pink-600/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500"></div>
            ...
            <div className="mt-12 text-center bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-8 border border-purple-200 dark:border-purple-700">
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-6">
                Our team is here to help you understand how the Growth & GTM Kit can transform your business
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 text-purple-100">
              Join hundreds of companies using the Growth & GTM Kit to transform their sales process
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10" asChild>
                <Link href="/solutions/novasuite">Compare All Kits</Link>
              </Button>
            </div>
          </div>
        </div>
