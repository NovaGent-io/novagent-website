      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          <div 
            ...
            style={{
              backgroundImage: `
                linear-gradient(${theme === 'dark' ? 'rgba(139, 92, 246, 0.1)' : 'rgba(139, 92, 246, 0.05)'} 2px, transparent 2px),
                linear-gradient(90deg, ${theme === 'dark' ? 'rgba(139, 92, 246, 0.1)' : 'rgba(139, 92, 246, 0.05)'} 2px, transparent 2px)
              `,
      ...
      >
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-6xl sm:text-7xl lg:text-8xl font-bold leading-[0.9]">
