...
export const industries: IndustryData[] = [
  ...
  // =================================================================
  // REAL ESTATE DATA - Updated from PDF
  // =================================================================
  {
    slug: 'real-estate',
    name: 'Real Estate',
    hero: {
      title: 'Automate Your Brokerage. Empower Your Agents.',
      subtitle: 'NovaGent provides a single, managed AI agent that handles lead qualification, appointment setting, and document management, allowing your real estate agents to focus on what they do best: closing deals.',
      heroIcon: <Home />
    },
    challenges: {
  ...
  // =================================================================
  // PUBLIC SECTOR DATA - New from PDF
  // =================================================================
  {
    slug: 'public-sector',
    name: 'Public Sector',
    hero: {
      title: 'Enhance Public Service. Modernize Your Operations.',
      subtitle: 'NovaGent provides government agencies and public sector organizations with a single AI agent to automate administrative tasks, manage compliance, and improve citizen services.',
      heroIcon: <Building2 />
    },
    challenges: {
      title: "Public Service Demands Unwavering Accountability and Efficiency",
      items: [
        { 
          icon: <FileText />, 
          title: 'Legacy Systems & Paperwork', 
          points: [
            "Manual, paper-based workflows create administrative burdens",
            "Outdated systems slow processes and limit data access",
            "Digital transformation is essential for modern governance"
          ] 
        },
        { 
          icon: <Gavel />, 
          ...
          points: [
            "Complex web of regulations and transparency laws",
            "Critical, high-stakes compliance responsibility",
            "Manual tracking creates liability risks"
          ] 
        },
        { 
          icon: <Users />, 
          title: 'High Volume of Citizen Inquiries', 
          points: [
            "Large volume of information requests and applications",
            "Requires significant staff time and resources",
            "Citizens expect responsive government services"
          ] 
        },
      ]
    },
    solutions: {
      title: 'Public Service & Operations Engine',
      subtitle: 'Automate administrative work, navigate regulations, and improve citizen accessibility.',
      items: [
        { 
          icon: <ShieldCheck />, 
          title: 'Compliance Management', 
          points: [
            "Monitor changes to public statutes and regulations",
            "Cross-reference with internal procedures",
            "Flag processes requiring compliance updates"
          ] 
        },
        { 
          ...
          points: [
            "Manage public projects with transparency",
        ...
        { 
          ...
          points: [
            "24/7 AI-powered public information officer",
            "Answer common citizen questions",
            "Process initial service applications"
          ] 
        },
        { 
          icon: <FileText />, 
          ...
          points: [
            "Draft standardized public notices",
            "Generate permit applications",
            "Create policy documents with approved templates"
          ] 
        },
      ]
    },
    agents: {
      title: 'Your Agent\'s Capabilities',
      items: [
        { icon: <ShieldCheck />, title: 'Compliance Management', description: 'Monitor regulatory changes and ensure agency compliance.', link: '/capabilities#compliance-management' },
        { icon: <GanttChartSquare />, title: 'Project Management', description: 'Manage public projects with transparency.', link: '/capabilities#project-management' },
        { icon: <MessageSquare />, title: 'Customer Support', description: 'Deploy 24/7 public information services.', link: '/capabilities#customer-support' },
        { icon: <FileText />, title: 'Legal Document Agent', description: 'Generate standardized documents.', link: '/capabilities#legal-document' },
      ]
    },
    results: {
      title: 'Results for Government Operations',
      items: [
        { icon: <Clock />, value: '60%', title: 'Faster 311 Response Times', description: 'Automated citizen inquiry processing.' },
        { icon: <FileText />, value: '40%', title: 'Improvement in Grant Processing', description: 'Streamlined application review.' },
        { icon: <Search />, value: '35%', title: 'Reduction in Records Retrieval', description: 'Intelligent document management.' },
      ]
    },
    cta: {
      title: 'Ready to Build a More Responsive Government?',
      subtitle: 'Schedule a consultation to modernize your public services.'
    }
  },

  // =================================================================
  // RETAIL DATA - New from PDF
  // =================================================================
  {
    slug: 'retail',
    name: 'Retail',
    hero: {
      title: 'The Intelligent Engine for Modern Commerce.',
      subtitle: 'NovaGent provides retailers and e-commerce brands with a single AI agent to automate inventory management, customer support, and ad campaigns.',
      heroIcon: <Store />
    },
    challenges: {
      title: "Retail Success is Won or Lost in the Margins",
      items: [
        { 
          icon: <Package />, 
          title: 'Complex Inventory & Pricing', 
          points: [
            "Managing thousands of SKUs across multiple channels",
            "Real-time pricing changes are error-prone",
            "Manual inventory leads to stockouts and overstock"
          ] 
        },
        { 
          icon: <ShoppingCart />, 
          title: 'High-Volume Customer Support', 
          points: [
            "Overwhelmed with order status and return inquiries",
        ...
        { 
          ...
          points: [
            "Wasted budget on underperforming creatives",
            "Wrong audience targeting hurts ROAS",
            "Manual campaign management is time-intensive"
          ] 
        },
      ]
    },
    solutions: {
      title: 'CommerceOps Engine Bundle',
      subtitle: 'Intelligent e-commerce operations management for efficient and profitable retail.',
      items: [
        { 
          icon: <ShoppingBag />, 
          title: 'E-commerce Operations', 
          points: [
            "Monitor product catalogs across all channels",
            "Flag pricing discrepancies and stock alerts",
        ...
        { 
          ...
          title: 'Customer Support', 
          points: [
            "24/7 AI-powered support for common questions",
            "Handle order tracking and return policies",
            "Free human team for complex issues"
          ] 
        },
        { 
          icon: <Target />, 
          ...
          points: [
            "A/B test ad creatives autonomously",
            "Identify winning campaigns and reallocate budget",
            "Maximize marketing ROI continuously"
          ] 
        },
        { 
          icon: <BarChart />, 
          ...
          points: [
            ...
            "Generate insights for purchasing decisions",
    ...
    agents: {
      title: 'Your Agent\'s Capabilities',
      items: [
        { icon: <ShoppingBag />, title: 'E-commerce Operations', description: 'Monitor catalogs and automate inventory management.', link: '/capabilities#ecommerce-operations' },
        { icon: <MessageSquare />, title: 'Customer Support', description: '24/7 AI-powered customer service.', link: '/capabilities#customer-support' },
        { icon: <Target />, title: 'Ad Campaign Manager', description: 'Optimize campaigns and maximize ROAS.', link: '/capabilities#ad-campaign-manager' },
        { icon: <BarChart />, title: 'Data Analytics & Reporting', description: 'Generate actionable business insights.', link: '/capabilities#analytics-reporting' },
      ]
    },
    results: {
      title: 'Results for Retail Operations',
      items: [
        { icon: <MessageSquare />, value: '70%', title: 'of Support Tickets Resolved by AI', description: 'Automated customer service.' },
        { icon: <TrendingUp />, value: '25%', title: 'Average ROAS Increase', description: 'Optimized ad campaigns.' },
        { icon: <Clock />, value: '15+', title: 'Hours/Week Saved on Social Media', description: 'Automated content creation.' },
      ]
    },
    cta: {
      title: 'Ready to Build a Smarter Retail Experience?',
      subtitle: 'Schedule a consultation to optimize your retail operations.'
    }
  },

  // =================================================================
  // TRAVEL & HOSPITALITY DATA - New from PDF
  // =================================================================
  {
    slug: 'travel-and-hospitality',
    name: 'Travel & Hospitality',
    hero: {
      title: 'Delight Every Guest. Automate Your Operations.',
      subtitle: 'NovaGent provides hotels, resorts, and travel agencies with a single AI agent to manage bookings, handle guest inquiries 24/7, and enhance online reputation.',
      heroIcon: <Plane />
    },
    challenges: {
      title: "The Hospitality Industry Thrives on Exceptional Service",
      items: [
        { 
          icon: <Bed />, 
          title: 'Complex Booking & Reservation Management', 
          points: [
            "High volume of booking inquiries and modifications",
            "Multiple platform management complexity",
            "Manual booking creates operational inefficiencies"
          ] 
        },
        { 
          icon: <MessageSquare />, 
          ...
          points: [
            "Guests need instant answers at all hours",
            "Questions about amenities and local attractions",
            "After-hours inquiries often go unanswered"
          ] 
        },
        { 
          icon: <Star />, 
          ...
          points: [
            "Reviews on TripAdvisor, Google, and Booking.com",
            "Critical for attracting new guests",
    ...
    solutions: {
      title: 'Hospitality & Guest Experience Engine',
      subtitle: '24/7 digital concierge and reservations management for seamless guest interactions.',
      items: [
        { 
          icon: <Calendar />, 
          ...
          points: [
            ...
            "Send automated confirmations to guests"
          ] 
        },
        { 
          icon: <MessageSquare />, 
          title: 'Customer Support', 
          points: [
            "AI concierge answers guest questions 24/7",
            "Provide information on amenities and policies",
            "Free front-desk staff for in-person service"
          ] 
        },
        { 
          icon: <Star />, 
          ...
          points: [
            ...
            "Send polite emails or SMS for feedback",
            "Climb rankings on review platforms"
          ] 
        },
        { 
          icon: <BarChart />, 
          title: 'Data Analytics & Reporting', 
          points: [
            "Analyze booking trends and guest feedback",
            "Generate reports for pricing optimization",
            "Improve service offerings with data insights"
          ] 
        },
      ]
    },
    agents: {
      title: 'Your Agent\'s Capabilities',
      items: [
        { icon: <Calendar />, title: 'Appointment Setting', description: 'Integrate with PMS systems for all bookings.', link: '/capabilities#appointment-setting' },
        { icon: <MessageSquare />, title: 'Customer Support', description: '24/7 AI concierge services.', link: '/capabilities#customer-support' },
        { icon: <Star />, title: 'SEO & Reputation', description: 'Automate review solicitation.', link: '/capabilities#seo-reputation' },
        { icon: <BarChart />, title: 'Data Analytics & Reporting', description: 'Analyze guest behavior and optimize services.', link: '/capabilities#analytics-reporting' },
      ]
    },
    results: {
      title: 'Results for Hospitality Operations',
      items: [
        { icon: <TrendingUp />, value: '45%', title: 'Increase in Booking Conversions', description: 'Streamlined reservation process.' },
        { icon: <Smile />, value: '35%', title: 'Improvement in Guest Satisfaction', description: 'Responsive and personalized service.' },
        { icon: <Truck />, value: '30%', title: 'Reduction in Operational Costs', description: 'Optimized resource management.' },
      ]
    },
    cta: {
      title: 'Ready to Create an Unforgettable Guest Experience?',
      subtitle: 'Schedule a consultation to transform your hospitality operations.'
    }
  },

  // =================================================================
  // TECHNOLOGY DATA - New from PDF
  // =================================================================
  {
    slug: 'technology',
    name: 'Technology',
    hero: {
      title: 'Scale Your Operations. Not Your Headcount.',
      subtitle: 'NovaGent provides B2B tech companies with a single AI agent to automate sales development, customer support, and internal workflows.',
      heroIcon: <Laptop />
    },
    challenges: {
      title: "High-Growth Tech Requires Hyper-Efficient Operations",
      items: [
        { 
          icon: <BarChart />, 
          title: 'Inefficient Sales Development', 
          points: [
            "Sales team spends time on manual prospecting",
            "Data entry slows down pipeline velocity",
        ...
        { 
          ...
          points: [
            "Overwhelmed with repetitive Tier-1 tickets",
            "Long resolution times impact satisfaction",
            "Support scaling doesn't match user growth"
          ] 
        },
        { 
          icon: <Network />, 
          ...
          points: [
            ...
            "Manual handoffs slow product launches",
    ...
    solutions: {
      title: 'Tech Growth Stack Bundle',
      subtitle: 'Intelligent operations hub for scaling efficiently without linear headcount increase.',
      items: [
        { 
          icon: <Target />, 
          title: 'Lead Generation', 
          points: [
            "Build hyper-targeted B2B customer lists",
            "Run personalized outreach campaigns",
            "Hand off only warm, qualified leads"
          ] 
        },
        { 
          icon: <MessageSquare />, 
          title: 'Customer Support', 
          points: [
            "AI specialist trained on technical docs",
            "Resolve 80% of Tier-1 tickets instantly",
        ...
        { 
          ...
          points: [
            ...
            "Automate status updates between teams",
            "Ensure alignment on key deliverables"
          ] 
        },
        { 
          icon: <UserPlus />, 
          ...
          points: [
            "Streamline entire onboarding process",
            "Handle offer letters and software access",
            "Schedule orientation for new hires"
          ] 
        },
      ]
    },
    agents: {
      title: 'Your Agent\'s Capabilities',
      items: [
        { icon: <Target />, title: 'Lead Generation', description: 'Automate B2B customer acquisition.', link: '/capabilities#lead-generation' },
        { icon: <MessageSquare />, title: 'Customer Support', description: 'AI-powered technical support.', link: '/capabilities#customer-support' },
        { icon: <GanttChartSquare />, title: 'Project Management', description: 'Coordinate teams and automate updates.', link: '/capabilities#project-management' },
        { icon: <UserPlus />, title: 'Employee Onboarding', description: 'Streamline new hire processes.', link: '/capabilities#employee-onboarding' },
      ]
    },
    results: {
      title: 'Results for Technology Companies',
      items: [
        { icon: <Code />, value: '50%', title: 'Faster Code Review Cycles', description: 'Automated workflow coordination.' },
        { icon: <Users />, value: '40%', title: 'Improvement in User Onboarding', description: 'Streamlined processes.' },
        { icon: <ShieldAlert />, value: '60%', title: 'Reduction in Security Response Time', description: 'Automated incident detection.' },
      ]
    },
    cta: {
      title: 'Ready to Build a More Scalable Company?',
      subtitle: 'Schedule a consultation to optimize your technology operations.'
    }
  },
];
